    ...
    >
      <div className="max-w-[1400px] mx-auto flex justify-between items-center px-4">
        <a href="/" className="flex items-center">
          <div
            className={`h-10 w-10 bg-blue-900 rounded-full flex items-center justify-center text-white font-bold transition-all duration-300 ease-in-out ${
          ...
          <span
            className={` text-blue-900 text-2xl font-bold ml-1 transition-all duration-300 ease-in-out ${
        ...
        <div className="hidden lg:flex space-x-4">
          <button
            ...
            className="bg-blue-900 hover:text-mainColor hover:border-[1px] hover:border-mainColor text-white lg:px-6 md:px-4 py-3 rounded-full font-medium text-sm hover:bg-white transition duration-500"
          >
            Log In
          </button>
          <button
            ...
            className="border-[1px] border-blue-900 text-blue-900 hover:text-white hover:bg-blue-900 lg:px-6 md:px-4 py-3 rounded-full text-sm font-medium transition duration-500"
          >
            Sign Up
          </button>
        </div>
        ...
        <div
          className={
            !isMobileMenuOpen
              ? "lg:hidden fixed left-[-100%] h-[75%] shadow-xl ease-in-out duration-1000 "
