    ...
    <div className="max-w-[1200px] lg:mx-auto mx-[20px] h-full grid lg:grid-cols-2 items-center">      
      <div className="p-2 flex flex-col justify-center">
        ...
        <p className="lg:text-[20px] text-[18px] text-start text-gray-600 leading-relaxed mt-8">
            <span className='font-semibold text-blue-900 underline'>Create a landlord account</span> to request an online rental application in minutes with your tenant’s name and email address.
        </p>
        <p className="lg:text-[20px] text-[18px] text-start text-gray-600 leading-relaxed mt-8">
